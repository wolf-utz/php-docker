...
typo3-87-composer: install
	docker cp ./.docker/make/typo3-87-composer.json app:/var/www/html/composer.json
...
typo3-87: install
	docker cp ./.docker/make/typo3-87.sh app:/typo3.sh
	docker exec app /bin/bash -c "cd / && chmod 777 /typo3.sh && ./typo3.sh"

typo3-76: install
	docker cp ./.docker/make/typo3-76.sh app:/typo3.sh
	docker exec app /bin/bash -c "cd / && chmod 777 /typo3.sh && ./typo3.sh"
